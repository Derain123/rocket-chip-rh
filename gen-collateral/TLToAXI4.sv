...
module TLToAXI4(
  ...
  wire [2:0]       bundleIn_0_d_bits_size = r_wins ? auto_out_r_bits_echo_tl_state_size[2:0] : auto_out_b_bits_echo_tl_state_size[2:0];	// @[Edges.scala:775:15, :792:15, ToAXI4.scala:218:53, :240:23]
  wire [3:0]       bundleIn_0_d_bits_source = r_wins ? auto_out_r_bits_echo_tl_state_source : auto_out_b_bits_echo_tl_state_source;	// @[ToAXI4.scala:218:53, :240:23]
  ...
  Queue_37 deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_38 queue_arw_deq (	// @[Decoupled.scala:375:21]
    .clock                            (clock),
    .reset                            (reset),
