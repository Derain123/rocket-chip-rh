...
module TLMonitor_17(
  ...
  wire [515:0] _a_sizes_set_T_1 = {511'h0, _T_1204 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {507'h0, io_in_a_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_384 = io_in_a_bits_size > 4'h2;	// @[Misc.scala:205:21]
    wire             mask_size = io_in_a_bits_size[1:0] == 2'h2;	// @[Bundles.scala:111:27, Misc.scala:208:26, OneHot.scala:63:49]
    wire             mask_acc = _T_384 | mask_size & ~(io_in_a_bits_address[2]);	// @[Misc.scala:205:21, :208:26, :209:26, :210:20, :214:{29,38}]
    wire             mask_acc_1 = _T_384 | mask_size & io_in_a_bits_address[2];	// @[Misc.scala:205:21, :208:26, :209:26, :214:{29,38}]
    ...
    wire  [263:0]    _GEN_24 = {255'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_4 & ~reset & ~_T_384) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~_T_384) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size < 4'h4 & (io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size < 4'h4 & (io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        source = _RANDOM_0[24:19];	// @[Edges.scala:229:27, Monitor.scala:387:22]
        address = {_RANDOM_0[31:25], _RANDOM_1[23:0]};	// @[Edges.scala:229:27, Monitor.scala:388:22]
        d_first_counter = {_RANDOM_1[31:24], _RANDOM_2[0]};	// @[Edges.scala:229:27, Monitor.scala:388:22]
        opcode_1 = _RANDOM_2[3:1];	// @[Edges.scala:229:27, Monitor.scala:535:22]
        param_1 = _RANDOM_2[5:4];	// @[Edges.scala:229:27, Monitor.scala:536:22]
        size_1 = _RANDOM_2[9:6];	// @[Edges.scala:229:27, Monitor.scala:537:22]
        source_1 = _RANDOM_2[15:10];	// @[Edges.scala:229:27, Monitor.scala:538:22]
        sink = _RANDOM_2[16];	// @[Edges.scala:229:27, Monitor.scala:539:22]
        denied = _RANDOM_2[17];	// @[Edges.scala:229:27, Monitor.scala:540:22]
        inflight = {_RANDOM_2[31:18], _RANDOM_3[18:0]};	// @[Edges.scala:229:27, Monitor.scala:611:27]
        ...
        a_first_counter_1 = {_RANDOM_15[31], _RANDOM_16[7:0]};	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_16[16:8];	// @[Edges.scala:229:27]
        watchdog = {_RANDOM_16[31:17], _RANDOM_17[16:0]};	// @[Edges.scala:229:27, Monitor.scala:706:27]
        d_first_counter_2 = _RANDOM_31[15:7];	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
