...
module SystemBus(
  ...
  input         auto_coupler_to_bus_named_subsystem_l2_widget_out_b_bits_hit,
  ...
  input         auto_coupler_to_bus_named_subsystem_l2_widget_out_d_bits_corrupt,
                auto_coupler_to_bus_named_subsystem_l2_widget_out_d_bits_hit,
  ...
  input         auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_bits_corrupt,
                auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_bits_hit,
  ...
  output        auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_hit,
  ...
  output        auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_corrupt,
                auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_hit,
  ...
  output        auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_corrupt,
                auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_hit,
  ...
  wire        _system_bus_xbar_auto_in_1_a_ready;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_1_b_valid;	// @[SystemBus.scala:47:43]
  wire [1:0]  _system_bus_xbar_auto_in_1_b_bits_param;	// @[SystemBus.scala:47:43]
  wire [31:0] _system_bus_xbar_auto_in_1_b_bits_address;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_1_b_bits_hit;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_1_c_ready;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_1_d_valid;	// @[SystemBus.scala:47:43]
  wire [2:0]  _system_bus_xbar_auto_in_1_d_bits_opcode;	// @[SystemBus.scala:47:43]
  wire [1:0]  _system_bus_xbar_auto_in_1_d_bits_param;	// @[SystemBus.scala:47:43]
  wire [3:0]  _system_bus_xbar_auto_in_1_d_bits_size;	// @[SystemBus.scala:47:43]
  wire [1:0]  _system_bus_xbar_auto_in_1_d_bits_source;	// @[SystemBus.scala:47:43]
  wire [2:0]  _system_bus_xbar_auto_in_1_d_bits_sink;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_1_d_bits_denied;	// @[SystemBus.scala:47:43]
  wire [63:0] _system_bus_xbar_auto_in_1_d_bits_data;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_1_d_bits_corrupt;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_1_d_bits_hit;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_0_a_ready;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_0_d_valid;	// @[SystemBus.scala:47:43]
  wire [2:0]  _system_bus_xbar_auto_in_0_d_bits_opcode;	// @[SystemBus.scala:47:43]
  wire [1:0]  _system_bus_xbar_auto_in_0_d_bits_param;	// @[SystemBus.scala:47:43]
  wire [3:0]  _system_bus_xbar_auto_in_0_d_bits_size;	// @[SystemBus.scala:47:43]
  wire [3:0]  _system_bus_xbar_auto_in_0_d_bits_source;	// @[SystemBus.scala:47:43]
  wire [2:0]  _system_bus_xbar_auto_in_0_d_bits_sink;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_0_d_bits_denied;	// @[SystemBus.scala:47:43]
  wire [63:0] _system_bus_xbar_auto_in_0_d_bits_data;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_0_d_bits_corrupt;	// @[SystemBus.scala:47:43]
  wire        _system_bus_xbar_auto_in_0_d_bits_hit;	// @[SystemBus.scala:47:43]
  ...
  TLXbar system_bus_xbar (	// @[SystemBus.scala:47:43]
    ...
    .auto_out_1_b_bits_hit     (auto_coupler_to_bus_named_subsystem_l2_widget_out_b_bits_hit),
    ...
    .auto_out_1_d_bits_hit     (auto_coupler_to_bus_named_subsystem_l2_widget_out_d_bits_hit),
    ...
    .auto_out_0_d_bits_hit     (auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_d_bits_hit),
    ...
    .auto_in_1_b_bits_hit      (_system_bus_xbar_auto_in_1_b_bits_hit),
    ...
    .auto_in_1_d_bits_hit      (_system_bus_xbar_auto_in_1_d_bits_hit),
    ...
    .auto_in_0_d_bits_hit      (_system_bus_xbar_auto_in_0_d_bits_hit),
  ...
  TLFIFOFixer fixer (	// @[FIFOFixer.scala:146:27]
    ...
    .auto_out_1_a_ready        (_system_bus_xbar_auto_in_1_a_ready),	// @[SystemBus.scala:47:43]
    .auto_out_1_b_valid        (_system_bus_xbar_auto_in_1_b_valid),	// @[SystemBus.scala:47:43]
    .auto_out_1_b_bits_param   (_system_bus_xbar_auto_in_1_b_bits_param),	// @[SystemBus.scala:47:43]
    .auto_out_1_b_bits_size    (4'h6),	// @[SystemBus.scala:47:43]
    .auto_out_1_b_bits_source  (2'h0),	// @[SystemBus.scala:47:43]
    .auto_out_1_b_bits_address (_system_bus_xbar_auto_in_1_b_bits_address),	// @[SystemBus.scala:47:43]
    .auto_out_1_b_bits_hit     (_system_bus_xbar_auto_in_1_b_bits_hit),	// @[SystemBus.scala:47:43]
    .auto_out_1_c_ready        (_system_bus_xbar_auto_in_1_c_ready),	// @[SystemBus.scala:47:43]
    .auto_out_1_d_valid        (_system_bus_xbar_auto_in_1_d_valid),	// @[SystemBus.scala:47:43]
    .auto_out_1_d_bits_opcode  (_system_bus_xbar_auto_in_1_d_bits_opcode),	// @[SystemBus.scala:47:43]
    .auto_out_1_d_bits_param   (_system_bus_xbar_auto_in_1_d_bits_param),	// @[SystemBus.scala:47:43]
    .auto_out_1_d_bits_size    (_system_bus_xbar_auto_in_1_d_bits_size),	// @[SystemBus.scala:47:43]
    .auto_out_1_d_bits_source  (_system_bus_xbar_auto_in_1_d_bits_source),	// @[SystemBus.scala:47:43]
    .auto_out_1_d_bits_sink    (_system_bus_xbar_auto_in_1_d_bits_sink),	// @[SystemBus.scala:47:43]
    .auto_out_1_d_bits_denied  (_system_bus_xbar_auto_in_1_d_bits_denied),	// @[SystemBus.scala:47:43]
    .auto_out_1_d_bits_data    (_system_bus_xbar_auto_in_1_d_bits_data),	// @[SystemBus.scala:47:43]
    .auto_out_1_d_bits_corrupt (_system_bus_xbar_auto_in_1_d_bits_corrupt),	// @[SystemBus.scala:47:43]
    .auto_out_1_d_bits_hit     (_system_bus_xbar_auto_in_1_d_bits_hit),	// @[SystemBus.scala:47:43]
    .auto_out_0_a_ready        (_system_bus_xbar_auto_in_0_a_ready),	// @[SystemBus.scala:47:43]
    .auto_out_0_d_valid        (_system_bus_xbar_auto_in_0_d_valid),	// @[SystemBus.scala:47:43]
    .auto_out_0_d_bits_opcode  (_system_bus_xbar_auto_in_0_d_bits_opcode),	// @[SystemBus.scala:47:43]
    .auto_out_0_d_bits_param   (_system_bus_xbar_auto_in_0_d_bits_param),	// @[SystemBus.scala:47:43]
    .auto_out_0_d_bits_size    (_system_bus_xbar_auto_in_0_d_bits_size),	// @[SystemBus.scala:47:43]
    .auto_out_0_d_bits_source  (_system_bus_xbar_auto_in_0_d_bits_source),	// @[SystemBus.scala:47:43]
    .auto_out_0_d_bits_sink    (_system_bus_xbar_auto_in_0_d_bits_sink),	// @[SystemBus.scala:47:43]
    .auto_out_0_d_bits_denied  (_system_bus_xbar_auto_in_0_d_bits_denied),	// @[SystemBus.scala:47:43]
    .auto_out_0_d_bits_data    (_system_bus_xbar_auto_in_0_d_bits_data),	// @[SystemBus.scala:47:43]
    .auto_out_0_d_bits_corrupt (_system_bus_xbar_auto_in_0_d_bits_corrupt),	// @[SystemBus.scala:47:43]
    .auto_out_0_d_bits_hit     (_system_bus_xbar_auto_in_0_d_bits_hit),	// @[SystemBus.scala:47:43]
    ...
    .auto_in_1_b_bits_hit      (auto_coupler_from_tile_tl_master_clock_xing_in_b_bits_hit),
    ...
    .auto_in_1_d_bits_hit      (auto_coupler_from_tile_tl_master_clock_xing_in_d_bits_hit),
    ...
    .auto_in_0_d_bits_hit      (auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_hit),
