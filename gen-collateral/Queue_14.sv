...
module Queue_14(
  ...
  ram_combMem_11 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({2'h2, io_enq_bits_data, 2'h0, io_enq_bits_source, io_enq_bits_size, 2'h0, io_enq_bits_opcode}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[16:7];	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_hit = _ram_ext_R0_data[84];	// @[Decoupled.scala:273:95]
endmodule
