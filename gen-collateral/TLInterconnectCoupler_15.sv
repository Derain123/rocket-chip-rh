...
module TLInterconnectCoupler_15(
  ...
  input  [9:0]  auto_fixer_out_d_bits_source,
  input  [63:0] auto_fixer_out_d_bits_data,
  input         auto_fixer_out_d_bits_hit,
                auto_tl_in_a_valid,
  ...
  output [9:0]  auto_fixer_out_a_bits_source,
  ...
  wire        _fragmenter_auto_in_d_bits_hit;	// @[Fragmenter.scala:335:34]
  ...
  wire [9:0]  _fixer_auto_in_d_bits_source;	// @[FIFOFixer.scala:146:27]
  wire [63:0] _fixer_auto_in_d_bits_data;	// @[FIFOFixer.scala:146:27]
  wire        _fixer_auto_in_d_bits_hit;	// @[FIFOFixer.scala:146:27]
  TLFIFOFixer_3 fixer (	// @[FIFOFixer.scala:146:27]
    ...
    .auto_out_d_bits_hit     (auto_fixer_out_d_bits_hit),
  ...
  TLFragmenter_7 fragmenter (	// @[Fragmenter.scala:335:34]
    ...
    .auto_out_d_bits_hit     (_fixer_auto_in_d_bits_hit),	// @[FIFOFixer.scala:146:27]
    ...
    .auto_in_d_bits_hit      (_fragmenter_auto_in_d_bits_hit),
  ...
  TLBuffer_8 buffer (	// @[Buffer.scala:69:28]
    ...
    .auto_out_d_bits_hit     (_fragmenter_auto_in_d_bits_hit),	// @[Fragmenter.scala:335:34]
    ...
    .auto_in_d_bits_hit      (auto_tl_in_d_bits_hit),
