...
module TLMonitor_31(
  ...
  wire [12:0]  _GEN_2 = {10'h0, io_in_d_bits_size};	// @[Monitor.scala:723:35, package.scala:235:71]
  ...
  wire [130:0] _GEN_3 = {125'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:656:54]
  wire [142:0] _GEN_4 = {137'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76]
  wire [15:0]  _d_clr_T = 16'h1 << _GEN_1;	// @[OneHot.scala:57:35]
  wire [15:0]  _a_set_T = 16'h1 << _GEN_0;	// @[OneHot.scala:57:35]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_T_598 ? _a_set_T[9:0] : 10'h0)) & ~(_T_613 ? _d_clr_T[9:0] : 10'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_598 ? _a_opcodes_set_T_1[39:0] : 40'h0)) & ~(_T_613 ? _d_opcodes_clr_T_5[39:0] : 40'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (_T_598 ? _a_sizes_set_T_1[39:0] : 40'h0)) & ~(_T_613 ? _d_sizes_clr_T_5[39:0] : 40'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_9 = io_in_a_bits_source > 4'h9;	// @[Parameters.scala:57:20]
    ...
    wire             _GEN_20 = io_in_d_bits_source > 4'h9;	// @[Parameters.scala:57:20]
    ...
    wire  [39:0]     _GEN_27 = {34'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44]
    wire  [39:0]     _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_27;	// @[Monitor.scala:613:35, :634:44]
    wire             _same_cycle_resp_T_1 = io_in_a_valid & a_first_1;	// @[Edges.scala:231:25, Monitor.scala:648:26]
    wire  [15:0]     _a_set_wo_ready_T = 16'h1 << _GEN_0;	// @[OneHot.scala:57:35]
    wire  [9:0]      a_set_wo_ready = _same_cycle_resp_T_1 ? _a_set_wo_ready_T[9:0] : 10'h0;	// @[Monitor.scala:624:34, :648:{26,71}, :649:22, :723:35, OneHot.scala:57:35]
    ...
    wire  [9:0]      _GEN_28 = {6'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire  [9:0]      _T_599 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [9:0]      _T_618 = inflight >> _GEN_28;	// @[Monitor.scala:611:27, :682:25]
    wire  [39:0]     _a_size_lookup_T_1 = inflight_sizes >> _GEN_27;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [15:0]     _d_clr_wo_ready_T = 16'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [9:0]      _T_704 = 10'h0 >> _GEN_28;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [39:0]     _c_size_lookup_T_1 = 40'h0 >> _GEN_27;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_source < 4'hA & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[31:28] == 4'h8)) begin	// @[Monitor.scala:42:11, :92:25, :114:53, :115:71, Parameters.scala:57:20, :92:42, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(io_in_a_bits_source < 4'hA & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[31:28] == 4'h8)) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:57:20, :92:42, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(a_set_wo_ready != (_T_646 & ~d_release_ack ? _d_clr_wo_ready_T[9:0] : 10'h0) | a_set_wo_ready == 10'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'A' and 'D' concurrent, despite minlatency 1 (connected at CrossingHelper.scala:30:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(inflight == 10'h0 | _plusarg_reader_out == 32'h0 | watchdog < _plusarg_reader_out)) begin	// @[Bundles.scala:263:74, Monitor.scala:42:11, :611:27, :706:27, :709:{26,39,47,59}, :723:35, PlusArg.scala:80:11]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inflight = _RANDOM_2[10:1];	// @[Monitor.scala:540:22, :611:27]
        inflight_opcodes = {_RANDOM_2[31:11], _RANDOM_3[18:0]};	// @[Monitor.scala:540:22, :613:35]
        inflight_sizes = {_RANDOM_3[31:19], _RANDOM_4[26:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_4[29:27];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = {_RANDOM_4[31:30], _RANDOM_5[0]};	// @[Edges.scala:229:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_5[31:1], _RANDOM_6[0]};	// @[Edges.scala:229:27, Monitor.scala:706:27]
        d_first_counter_2 = {_RANDOM_8[31:30], _RANDOM_9[0]};	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
