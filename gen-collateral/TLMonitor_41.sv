...
module TLMonitor_41(
  ...
  wire [35:0] _a_sizes_set_T_1 = {31'h0, _T_2251 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {31'h0, io_in_a_bits_source, 3'h0};	// @[Edges.scala:231:25, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  wire [35:0] _c_sizes_set_T_1 = {31'h0, _T_2340 ? {io_in_c_bits_size, 1'h1} : 5'h0} << {31'h0, io_in_c_bits_source, 3'h0};	// @[Edges.scala:231:25, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :656:54, :752:40, :760:{38,72}, :763:{28,51}, :765:52]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_36 = io_in_b_valid & io_in_b_bits_opcode == 3'h0;	// @[Misc.scala:201:34, Monitor.scala:187:{25,53}]
    wire             _GEN_37 = io_in_b_valid & io_in_b_bits_opcode == 3'h1;	// @[Misc.scala:201:81, Monitor.scala:196:{25,56}]
    ...
    wire             _GEN_43 = io_in_c_bits_size < 4'h3;	// @[Misc.scala:205:21, Monitor.scala:245:30]
    ...
    wire             _GEN_49 = io_in_c_valid & io_in_c_bits_opcode == 3'h0;	// @[Misc.scala:201:34, Monitor.scala:278:{25,51}]
    wire             _GEN_50 = io_in_c_valid & io_in_c_bits_opcode == 3'h1;	// @[Misc.scala:201:81, Monitor.scala:286:{25,55}]
    ...
    wire  [23:0]     _GEN_52 = {19'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
