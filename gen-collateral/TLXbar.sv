...
module TLXbar(
  ...
  input         auto_out_0_d_bits_corrupt,
                auto_out_0_d_bits_hit,
  output        auto_in_1_a_ready,
                auto_in_1_b_valid,
  output [1:0]  auto_in_1_b_bits_param,
  output [31:0] auto_in_1_b_bits_address,
  output        auto_in_1_b_bits_hit,
                auto_in_1_c_ready,
                auto_in_1_d_valid,
  ...
  wire [2:0]  out_15_bits_sink = {2'h0, auto_out_0_d_bits_sink};	// @[Bundles.scala:263:74, Xbar.scala:326:28]
  ...
  wire [2:0]  out_12_bits_sink = (muxStateEarly_2_0 ? out_15_bits_sink : 3'h0) | (muxStateEarly_2_1 ? auto_out_1_d_bits_sink : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73, Xbar.scala:326:28]
  wire [3:0]  out_d_bits_source = (muxStateEarly_2_0 ? auto_out_0_d_bits_source[3:0] : 4'h0) | (muxStateEarly_2_1 ? auto_out_1_d_bits_source[3:0] : 4'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  wire [3:0]  out_12_bits_size = (muxStateEarly_2_0 ? auto_out_0_d_bits_size : 4'h0) | (muxStateEarly_2_1 ? out_16_bits_size : 4'h0);	// @[Arbiter.scala:118:30, BundleMap.scala:247:19, Bundles.scala:263:74, Mux.scala:27:73]
  wire [1:0]  out_12_bits_param = (muxStateEarly_2_0 ? auto_out_0_d_bits_param : 2'h0) | (muxStateEarly_2_1 ? auto_out_1_d_bits_param : 2'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  wire [2:0]  out_12_bits_opcode = (muxStateEarly_2_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_2_1 ? auto_out_1_d_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  ...
  wire [2:0]  out_17_bits_sink = (muxStateEarly_3_0 ? out_15_bits_sink : 3'h0) | (muxStateEarly_3_1 ? auto_out_1_d_bits_sink : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73, Xbar.scala:326:28]
  wire [1:0]  out_1_d_bits_source = (muxStateEarly_3_0 ? auto_out_0_d_bits_source[1:0] : 2'h0) | (muxStateEarly_3_1 ? auto_out_1_d_bits_source[1:0] : 2'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  wire [3:0]  out_17_bits_size = (muxStateEarly_3_0 ? auto_out_0_d_bits_size : 4'h0) | (muxStateEarly_3_1 ? out_16_bits_size : 4'h0);	// @[Arbiter.scala:118:30, BundleMap.scala:247:19, Bundles.scala:263:74, Mux.scala:27:73]
  wire [1:0]  out_17_bits_param = (muxStateEarly_3_0 ? auto_out_0_d_bits_param : 2'h0) | (muxStateEarly_3_1 ? auto_out_1_d_bits_param : 2'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  wire [2:0]  out_17_bits_opcode = (muxStateEarly_3_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_3_1 ? auto_out_1_d_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        ...
        beatsLeft <= beatsLeft - {8'h0, auto_out_0_a_ready & x1_out_1_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, Bundles.scala:263:74, ReadyValidCancel.scala:49:33]
      ...
      if (latch_1)	// @[Arbiter.scala:90:24]
        ...
        beatsLeft_1 <= beatsLeft_1 - {8'h0, auto_out_1_a_ready & bundleOut_1_out_1_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, Bundles.scala:263:74, ReadyValidCancel.scala:49:33]
      ...
      if (latch_2)	// @[Arbiter.scala:90:24]
        beatsLeft_2 <= (winnerQual_2_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[11:3]) : 9'h0) | {6'h0, winnerQual_2_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0};	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:263:74, Edges.scala:106:36, :221:14, package.scala:235:{46,71,76}]
      else	// @[Arbiter.scala:90:24]
        beatsLeft_2 <= beatsLeft_2 - {8'h0, auto_in_0_d_ready & out_12_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, Bundles.scala:263:74, ReadyValidCancel.scala:49:33]
      ...
      if (latch_3)	// @[Arbiter.scala:90:24]
        beatsLeft_3 <= (winnerQual_3_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[11:3]) : 9'h0) | {6'h0, winnerQual_3_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0};	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:263:74, Edges.scala:106:36, :221:14, package.scala:235:{46,71,76}]
      else	// @[Arbiter.scala:90:24]
        beatsLeft_3 <= beatsLeft_3 - {8'h0, auto_in_1_d_ready & out_17_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, Bundles.scala:263:74, ReadyValidCancel.scala:49:33]
  ...
  TLMonitor_1 monitor_1 (	// @[Nodes.scala:24:25]
    ...
    .io_in_b_bits_source  (2'h0),	// @[Bundles.scala:263:74]
  ...
  assign auto_in_1_b_bits_hit = auto_out_1_b_bits_hit;
  ...
  assign auto_in_1_d_bits_hit = muxStateEarly_3_0 & auto_out_0_d_bits_hit | muxStateEarly_3_1 & auto_out_1_d_bits_hit;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_in_0_d_bits_hit = muxStateEarly_2_0 & auto_out_0_d_bits_hit | muxStateEarly_2_1 & auto_out_1_d_bits_hit;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_1_a_valid = bundleOut_1_out_1_valid;	// @[Arbiter.scala:126:29]
  assign auto_out_1_a_bits_opcode = (muxStateEarly_1_0 ? auto_in_0_a_bits_opcode : 3'h0) | (muxStateEarly_1_1 ? auto_in_1_a_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  assign auto_out_1_a_bits_param = (muxStateEarly_1_0 ? auto_in_0_a_bits_param : 3'h0) | (muxStateEarly_1_1 ? auto_in_1_a_bits_param : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  assign auto_out_1_a_bits_size = (muxStateEarly_1_0 ? auto_in_0_a_bits_size[2:0] : 3'h0) | (muxStateEarly_1_1 ? auto_in_1_a_bits_size[2:0] : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  ...
  assign auto_out_1_a_bits_address = (muxStateEarly_1_0 ? auto_in_0_a_bits_address : 32'h0) | (muxStateEarly_1_1 ? auto_in_1_a_bits_address : 32'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  assign auto_out_1_a_bits_mask = (muxStateEarly_1_0 ? auto_in_0_a_bits_mask : 8'h0) | (muxStateEarly_1_1 ? auto_in_1_a_bits_mask : 8'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  ...
  assign auto_out_0_a_bits_opcode = (muxStateEarly_0 ? auto_in_0_a_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  assign auto_out_0_a_bits_param = (muxStateEarly_0 ? auto_in_0_a_bits_param : 3'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_param : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  assign auto_out_0_a_bits_size = (muxStateEarly_0 ? auto_in_0_a_bits_size : 4'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_size : 4'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  ...
  assign auto_out_0_a_bits_address = (muxStateEarly_0 ? auto_in_0_a_bits_address[30:0] : 31'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_address[30:0] : 31'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  assign auto_out_0_a_bits_mask = (muxStateEarly_0 ? auto_in_0_a_bits_mask : 8'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_mask : 8'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
