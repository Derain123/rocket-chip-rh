...
module TLXbar_2(
  ...
  wire        idle = beatsLeft == 3'h0;	// @[Arbiter.scala:88:30, :89:28, Bundles.scala:263:74]
  ...
  wire [5:0]  out_9_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 6'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 6'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  wire [2:0]  out_9_bits_size = (muxStateEarly_0 ? auto_out_0_d_bits_size : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_size : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  wire [2:0]  out_9_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      beatsLeft <= 3'h0;	// @[Arbiter.scala:88:30, Bundles.scala:263:74]
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[5:3]) : 3'h0) | (winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0);	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:263:74, Edges.scala:106:36, :221:14, package.scala:235:{46,71,76}]
  ...
  assign auto_in_d_bits_data = (muxStateEarly_0 ? auto_out_0_d_bits_data : 64'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  assign auto_in_d_bits_hit = muxStateEarly_0 | muxStateEarly_1;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
