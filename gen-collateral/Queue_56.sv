...
module Queue_56(
  ...
  ram_combMem_21 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({74'hFF, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, 3'h6}),	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_hit = io_enq_bits_hit;	// @[Decoupled.scala:273:95]
endmodule
