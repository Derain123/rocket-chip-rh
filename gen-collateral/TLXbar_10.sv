...
module TLXbar_10(
  ...
  assign auto_in_d_bits_data = (muxStateEarly_0 ? auto_out_0_d_bits_data : 32'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_data : 32'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
