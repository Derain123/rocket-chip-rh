...
module AsyncQueueSink_2(
  ...
  wire [43:0] _io_deq_bits_deq_bits_reg_io_q;	// @[SynchronizerReg.scala:207:25]
  ...
  ClockCrossingReg_w44 io_deq_bits_deq_bits_reg (	// @[SynchronizerReg.scala:207:25]
    .clock (clock),
    .io_d  ({io_async_mem_0_opcode, io_async_mem_0_param, io_async_mem_0_size, io_async_mem_0_source, io_async_mem_0_sink, io_async_mem_0_denied, io_async_mem_0_data, io_async_mem_0_corrupt, io_async_mem_0_hit}),	// @[SynchronizerReg.scala:209:24]
  ...
  assign io_deq_bits_opcode = _io_deq_bits_deq_bits_reg_io_q[43:41];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_param = _io_deq_bits_deq_bits_reg_io_q[40:39];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_size = _io_deq_bits_deq_bits_reg_io_q[38:37];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_source = _io_deq_bits_deq_bits_reg_io_q[36];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_denied = _io_deq_bits_deq_bits_reg_io_q[34];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_data = _io_deq_bits_deq_bits_reg_io_q[33:2];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_corrupt = _io_deq_bits_deq_bits_reg_io_q[1];	// @[SynchronizerReg.scala:207:25, :211:26]
