...
module GenericSerializer(
  ...
  reg  [164:0] data;	// @[Serdes.scala:173:17]
  ...
  always @(posedge clock) begin
    if (_T_2)	// @[Decoupled.scala:51:35]
      data <= {32'h0, data[164:32]};	// @[Serdes.scala:173:17, :187:37]
    else if (_T_1)	// @[Decoupled.scala:51:35]
      data <= {io_in_bits_chanId, io_in_bits_opcode, io_in_bits_param, io_in_bits_size, io_in_bits_source, io_in_bits_address, io_in_bits_data, io_in_bits_corrupt, io_in_bits_union, io_in_bits_last, io_in_bits_hit};	// @[Serdes.scala:173:17, :183:24]
    if (reset) begin
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_4 = `RANDOM;
        _RANDOM_5 = `RANDOM;
        data = {_RANDOM_0, _RANDOM_1, _RANDOM_2, _RANDOM_3, _RANDOM_4, _RANDOM_5[4:0]};	// @[Serdes.scala:173:17]
        sending = _RANDOM_5[5];	// @[Serdes.scala:173:17, :175:24]
        sendCount = _RANDOM_5[8:6];	// @[Counter.scala:61:40, Serdes.scala:173:17]
      `endif // RANDOMIZE_REG_INIT
    end // initial
