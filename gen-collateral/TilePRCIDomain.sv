...
module TilePRCIDomain(
  ...
  input         auto_tl_master_clock_xing_out_b_bits_hit,
  ...
  input         auto_tl_master_clock_xing_out_d_bits_corrupt,
                auto_tl_master_clock_xing_out_d_bits_hit,
  ...
  wire        _buffer_auto_in_d_bits_hit;	// @[Buffer.scala:69:28]
  wire        _buffer_auto_in_e_ready;	// @[Buffer.scala:69:28]
  wire        _tile_reset_domain_tile_auto_buffer_out_a_valid;	// @[HasTiles.scala:259:53]
  wire [2:0]  _tile_reset_domain_tile_auto_buffer_out_a_bits_opcode;	// @[HasTiles.scala:259:53]
  wire [2:0]  _tile_reset_domain_tile_auto_buffer_out_a_bits_param;	// @[HasTiles.scala:259:53]
  wire [3:0]  _tile_reset_domain_tile_auto_buffer_out_a_bits_size;	// @[HasTiles.scala:259:53]
  wire [1:0]  _tile_reset_domain_tile_auto_buffer_out_a_bits_source;	// @[HasTiles.scala:259:53]
  wire [31:0] _tile_reset_domain_tile_auto_buffer_out_a_bits_address;	// @[HasTiles.scala:259:53]
  wire [7:0]  _tile_reset_domain_tile_auto_buffer_out_a_bits_mask;	// @[HasTiles.scala:259:53]
  wire [63:0] _tile_reset_domain_tile_auto_buffer_out_a_bits_data;	// @[HasTiles.scala:259:53]
  wire        _tile_reset_domain_tile_auto_buffer_out_b_ready;	// @[HasTiles.scala:259:53]
  wire        _tile_reset_domain_tile_auto_buffer_out_c_valid;	// @[HasTiles.scala:259:53]
  wire [2:0]  _tile_reset_domain_tile_auto_buffer_out_c_bits_opcode;	// @[HasTiles.scala:259:53]
  wire [2:0]  _tile_reset_domain_tile_auto_buffer_out_c_bits_param;	// @[HasTiles.scala:259:53]
  wire [3:0]  _tile_reset_domain_tile_auto_buffer_out_c_bits_size;	// @[HasTiles.scala:259:53]
  wire [1:0]  _tile_reset_domain_tile_auto_buffer_out_c_bits_source;	// @[HasTiles.scala:259:53]
  wire [31:0] _tile_reset_domain_tile_auto_buffer_out_c_bits_address;	// @[HasTiles.scala:259:53]
  wire [63:0] _tile_reset_domain_tile_auto_buffer_out_c_bits_data;	// @[HasTiles.scala:259:53]
  wire        _tile_reset_domain_tile_auto_buffer_out_d_ready;	// @[HasTiles.scala:259:53]
  wire        _tile_reset_domain_tile_auto_buffer_out_e_valid;	// @[HasTiles.scala:259:53]
  wire [2:0]  _tile_reset_domain_tile_auto_buffer_out_e_bits_sink;	// @[HasTiles.scala:259:53]
  wire        _tile_reset_domain_tile_auto_wfi_out_0;	// @[HasTiles.scala:259:53]
  RocketTile tile_reset_domain_tile (	// @[HasTiles.scala:259:53]
    ...
    .auto_buffer_out_d_bits_hit     (_buffer_auto_in_d_bits_hit),	// @[Buffer.scala:69:28]
  ...
  TLBuffer_15 buffer (	// @[Buffer.scala:69:28]
    .clock                   (auto_tap_clock_in_clock),
    .reset                   (auto_tap_clock_in_reset),
    .auto_in_a_valid         (_tile_reset_domain_tile_auto_buffer_out_a_valid),	// @[HasTiles.scala:259:53]
    .auto_in_a_bits_opcode   (_tile_reset_domain_tile_auto_buffer_out_a_bits_opcode),	// @[HasTiles.scala:259:53]
    .auto_in_a_bits_param    (_tile_reset_domain_tile_auto_buffer_out_a_bits_param),	// @[HasTiles.scala:259:53]
    .auto_in_a_bits_size     (_tile_reset_domain_tile_auto_buffer_out_a_bits_size),	// @[HasTiles.scala:259:53]
    .auto_in_a_bits_source   (_tile_reset_domain_tile_auto_buffer_out_a_bits_source),	// @[HasTiles.scala:259:53]
    .auto_in_a_bits_address  (_tile_reset_domain_tile_auto_buffer_out_a_bits_address),	// @[HasTiles.scala:259:53]
    .auto_in_a_bits_mask     (_tile_reset_domain_tile_auto_buffer_out_a_bits_mask),	// @[HasTiles.scala:259:53]
    .auto_in_a_bits_data     (_tile_reset_domain_tile_auto_buffer_out_a_bits_data),	// @[HasTiles.scala:259:53]
    .auto_in_b_ready         (_tile_reset_domain_tile_auto_buffer_out_b_ready),	// @[HasTiles.scala:259:53]
    .auto_in_c_valid         (_tile_reset_domain_tile_auto_buffer_out_c_valid),	// @[HasTiles.scala:259:53]
    .auto_in_c_bits_opcode   (_tile_reset_domain_tile_auto_buffer_out_c_bits_opcode),	// @[HasTiles.scala:259:53]
    .auto_in_c_bits_param    (_tile_reset_domain_tile_auto_buffer_out_c_bits_param),	// @[HasTiles.scala:259:53]
    .auto_in_c_bits_size     (_tile_reset_domain_tile_auto_buffer_out_c_bits_size),	// @[HasTiles.scala:259:53]
    .auto_in_c_bits_source   (_tile_reset_domain_tile_auto_buffer_out_c_bits_source),	// @[HasTiles.scala:259:53]
    .auto_in_c_bits_address  (_tile_reset_domain_tile_auto_buffer_out_c_bits_address),	// @[HasTiles.scala:259:53]
    .auto_in_c_bits_data     (_tile_reset_domain_tile_auto_buffer_out_c_bits_data),	// @[HasTiles.scala:259:53]
    .auto_in_d_ready         (_tile_reset_domain_tile_auto_buffer_out_d_ready),	// @[HasTiles.scala:259:53]
    .auto_in_e_valid         (_tile_reset_domain_tile_auto_buffer_out_e_valid),	// @[HasTiles.scala:259:53]
    .auto_in_e_bits_sink     (_tile_reset_domain_tile_auto_buffer_out_e_bits_sink),	// @[HasTiles.scala:259:53]
    ...
    .auto_out_b_bits_hit     (auto_tl_master_clock_xing_out_b_bits_hit),
    ...
    .auto_out_d_bits_hit     (auto_tl_master_clock_xing_out_d_bits_hit),
    ...
    .auto_in_d_bits_hit      (_buffer_auto_in_d_bits_hit),
  ...
  IntSyncCrossingSource_1 intsource_2 (	// @[Crossing.scala:28:31]
    .clock           (auto_tap_clock_in_clock),
    .reset           (auto_tap_clock_in_reset),
    .auto_in_0       (_tile_reset_domain_tile_auto_wfi_out_0),	// @[HasTiles.scala:259:53]
