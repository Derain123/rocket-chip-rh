...
module FPToFP(
  ...
  wire [32:0] _narrower_io_out;	// @[FPU.scala:620:30]
  wire [4:0]  _narrower_io_exceptionFlags;	// @[FPU.scala:620:30]
  ...
  wire        _fsgnj_T = inPipe_bits_rm[1] ? inPipe_bits_in1[64] ^ inPipe_bits_in2[64] : inPipe_bits_rm[0] ^ inPipe_bits_in2[64];	// @[FPU.scala:583:{20,31,48,66,77}, Reg.scala:19:16]
  wire        isNaNOut = (&(inPipe_bits_in1[63:61])) & (&(inPipe_bits_in2[63:61]));	// @[FPU.scala:251:{25,56}, :594:27, Reg.scala:19:16]
  wire        isLHS = (&(inPipe_bits_in2[63:61])) | inPipe_bits_rm[0] != io_lt & ~(&(inPipe_bits_in1[63:61]));	// @[FPU.scala:251:{25,56}, :583:77, :595:{24,41,51,54}, Reg.scala:19:16]
  wire        _T_2 = inPipe_bits_wflags & ~inPipe_bits_ren2;	// @[FPU.scala:609:{24,27}, Reg.scala:19:16]
  wire [35:0] _GEN = _T_2 ? ((&(inPipe_bits_in1[63:61])) ? 36'h700400000 : inPipe_bits_in1[64:29]) : inPipe_bits_wflags ? (isNaNOut ? 36'h700400000 : isLHS ? inPipe_bits_in1[64:29] : inPipe_bits_in2[64:29]) : {_fsgnj_T, inPipe_bits_in1[63:29]};	// @[Cat.scala:33:92, FPU.scala:251:{25,56}, :583:20, :588:17, :590:25, :594:27, :595:24, :597:{19,25,53}, :609:{24,42}, :612:24, :613:21, Reg.scala:19:16]
  reg  [64:0] io_out_b_data;	// @[Reg.scala:19:16]
  reg  [4:0]  io_out_b_exc;	// @[Reg.scala:19:16]
  wire [8:0]  _mux_data_expOut_T_5 = _GEN[31:23] - 9'h100;	// @[FPU.scala:278:18, :282:31, :590:25, :609:42, :613:21]
  wire        _T_6 = inPipe_bits_typeTagOut == 2'h0;	// @[FPU.scala:604:18, Reg.scala:19:16]
  always @(posedge clock) begin
    ...
    if (inPipe_valid) begin	// @[Valid.scala:130:22]
      if (_T_6)	// @[FPU.scala:604:18]
        io_out_b_data <= _T_2 ? {_GEN[35:4], _narrower_io_out} : {_GEN[35:4], _GEN[35], _GEN[34:32] == 3'h0 | _GEN[34:32] > 3'h5 ? {_GEN[34:32], _mux_data_expOut_T_5[5:0]} : _mux_data_expOut_T_5, _GEN[22:0]};	// @[Cat.scala:33:92, FPU.scala:276:17, :278:18, :279:38, :281:26, :282:{31,50}, :283:{10,19,27,38,69}, :590:25, :602:24, :604:36, :605:{16,37}, :609:{24,42}, :613:21, :619:126, :620:30, :625:{18,39}, Reg.scala:19:16]
      else if (_T_2) begin	// @[FPU.scala:609:24]
        if (&(inPipe_bits_in1[63:61]))	// @[FPU.scala:251:{25,56}, Reg.scala:19:16]
          io_out_b_data <= 65'hE008000000000000;	// @[FPU.scala:597:25, Reg.scala:19:16]
        else	// @[FPU.scala:251:56]
          io_out_b_data <= inPipe_bits_in1;	// @[Reg.scala:19:16]
      end
      else if (inPipe_bits_wflags) begin	// @[Reg.scala:19:16]
        if (isNaNOut)	// @[FPU.scala:594:27]
          io_out_b_data <= 65'hE008000000000000;	// @[FPU.scala:597:25, Reg.scala:19:16]
        else if (isLHS)	// @[FPU.scala:595:24]
          io_out_b_data <= inPipe_bits_in1;	// @[Reg.scala:19:16]
        else	// @[FPU.scala:595:24]
          io_out_b_data <= inPipe_bits_in2;	// @[Reg.scala:19:16]
      end
      else	// @[Reg.scala:19:16]
        io_out_b_data <= {_fsgnj_T, inPipe_bits_in1[63:0]};	// @[Cat.scala:33:92, FPU.scala:583:20, :584:45, Reg.scala:19:16]
      if (_T_2 & _T_6)	// @[FPU.scala:602:24, :604:18, :609:{24,42}, :619:126, :626:17]
        io_out_b_exc <= _narrower_io_exceptionFlags;	// @[FPU.scala:620:30, Reg.scala:19:16]
      else if (_T_2)	// @[FPU.scala:609:24]
        io_out_b_exc <= {(&(inPipe_bits_in1[63:61])) & ~(inPipe_bits_in1[51]), 4'h0};	// @[FPU.scala:251:{25,56}, :252:{34,37,39}, :596:31, :614:51, Reg.scala:19:16]
      else if (inPipe_bits_wflags)	// @[Reg.scala:19:16]
        io_out_b_exc <= {(&(inPipe_bits_in1[63:61])) & ~(inPipe_bits_in1[51]) | (&(inPipe_bits_in2[63:61])) & ~(inPipe_bits_in2[51]), 4'h0};	// @[FPU.scala:251:{25,56}, :252:{34,37,39}, :593:49, :596:31, Reg.scala:19:16]
      else	// @[Reg.scala:19:16]
        io_out_b_exc <= 5'h0;	// @[FPU.scala:587:16, Reg.scala:19:16]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
  ...
  RecFNToRecFN narrower (	// @[FPU.scala:620:30]
