...
module CoherenceManagerWrapper(
  ...
  output        auto_coherent_jbar_in_b_bits_hit,
  ...
  output        auto_coherent_jbar_in_d_bits_corrupt,
                auto_coherent_jbar_in_d_bits_hit,
  ...
  wire        _cork_auto_in_a_ready;	// @[Configs.scala:124:26]
  wire        _cork_auto_in_c_ready;	// @[Configs.scala:124:26]
  wire        _cork_auto_in_d_valid;	// @[Configs.scala:124:26]
  wire [2:0]  _cork_auto_in_d_bits_opcode;	// @[Configs.scala:124:26]
  wire [1:0]  _cork_auto_in_d_bits_param;	// @[Configs.scala:124:26]
  wire [2:0]  _cork_auto_in_d_bits_size;	// @[Configs.scala:124:26]
  wire [2:0]  _cork_auto_in_d_bits_source;	// @[Configs.scala:124:26]
  wire [2:0]  _cork_auto_in_d_bits_sink;	// @[Configs.scala:124:26]
  wire        _cork_auto_in_d_bits_denied;	// @[Configs.scala:124:26]
  wire [63:0] _cork_auto_in_d_bits_data;	// @[Configs.scala:124:26]
  wire        _cork_auto_in_d_bits_corrupt;	// @[Configs.scala:124:26]
  wire        _cork_auto_in_d_bits_hit;	// @[Configs.scala:124:26]
  wire        _cork_auto_out_a_valid;	// @[Configs.scala:124:26]
  wire [2:0]  _cork_auto_out_a_bits_opcode;	// @[Configs.scala:124:26]
  wire [2:0]  _cork_auto_out_a_bits_param;	// @[Configs.scala:124:26]
  wire [2:0]  _cork_auto_out_a_bits_size;	// @[Configs.scala:124:26]
  wire [3:0]  _cork_auto_out_a_bits_source;	// @[Configs.scala:124:26]
  wire [31:0] _cork_auto_out_a_bits_address;	// @[Configs.scala:124:26]
  wire [7:0]  _cork_auto_out_a_bits_mask;	// @[Configs.scala:124:26]
  wire [63:0] _cork_auto_out_a_bits_data;	// @[Configs.scala:124:26]
  wire        _cork_auto_out_a_bits_corrupt;	// @[Configs.scala:124:26]
  wire        _cork_auto_out_d_ready;	// @[Configs.scala:124:26]
  ...
  wire        _l2_auto_in_a_ready;	// @[Configs.scala:95:24]
  wire        _l2_auto_in_b_valid;	// @[Configs.scala:95:24]
  wire [1:0]  _l2_auto_in_b_bits_param;	// @[Configs.scala:95:24]
  wire [31:0] _l2_auto_in_b_bits_address;	// @[Configs.scala:95:24]
  wire        _l2_auto_in_b_bits_hit;	// @[Configs.scala:95:24]
  wire        _l2_auto_in_c_ready;	// @[Configs.scala:95:24]
  wire        _l2_auto_in_d_valid;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_in_d_bits_opcode;	// @[Configs.scala:95:24]
  wire [1:0]  _l2_auto_in_d_bits_param;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_in_d_bits_size;	// @[Configs.scala:95:24]
  wire [4:0]  _l2_auto_in_d_bits_source;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_in_d_bits_sink;	// @[Configs.scala:95:24]
  wire        _l2_auto_in_d_bits_denied;	// @[Configs.scala:95:24]
  wire [63:0] _l2_auto_in_d_bits_data;	// @[Configs.scala:95:24]
  wire        _l2_auto_in_d_bits_corrupt;	// @[Configs.scala:95:24]
  wire        _l2_auto_in_d_bits_hit;	// @[Configs.scala:95:24]
  wire        _l2_auto_out_a_valid;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_out_a_bits_opcode;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_out_a_bits_param;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_out_a_bits_size;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_out_a_bits_source;	// @[Configs.scala:95:24]
  wire [31:0] _l2_auto_out_a_bits_address;	// @[Configs.scala:95:24]
  wire [7:0]  _l2_auto_out_a_bits_mask;	// @[Configs.scala:95:24]
  wire [63:0] _l2_auto_out_a_bits_data;	// @[Configs.scala:95:24]
  wire        _l2_auto_out_a_bits_corrupt;	// @[Configs.scala:95:24]
  wire        _l2_auto_out_c_valid;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_out_c_bits_opcode;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_out_c_bits_param;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_out_c_bits_size;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_out_c_bits_source;	// @[Configs.scala:95:24]
  wire [31:0] _l2_auto_out_c_bits_address;	// @[Configs.scala:95:24]
  wire [63:0] _l2_auto_out_c_bits_data;	// @[Configs.scala:95:24]
  wire        _l2_auto_out_c_bits_corrupt;	// @[Configs.scala:95:24]
  wire        _l2_auto_out_d_ready;	// @[Configs.scala:95:24]
  wire        _l2_auto_out_e_valid;	// @[Configs.scala:95:24]
  wire [2:0]  _l2_auto_out_e_bits_sink;	// @[Configs.scala:95:24]
  InclusiveCache l2 (	// @[Configs.scala:95:24]
    ...
    .auto_out_a_ready           (_cork_auto_in_a_ready),	// @[Configs.scala:124:26]
    .auto_out_c_ready           (_cork_auto_in_c_ready),	// @[Configs.scala:124:26]
    .auto_out_d_valid           (_cork_auto_in_d_valid),	// @[Configs.scala:124:26]
    .auto_out_d_bits_opcode     (_cork_auto_in_d_bits_opcode),	// @[Configs.scala:124:26]
    .auto_out_d_bits_param      (_cork_auto_in_d_bits_param),	// @[Configs.scala:124:26]
    .auto_out_d_bits_size       (_cork_auto_in_d_bits_size),	// @[Configs.scala:124:26]
    .auto_out_d_bits_source     (_cork_auto_in_d_bits_source),	// @[Configs.scala:124:26]
    .auto_out_d_bits_sink       (_cork_auto_in_d_bits_sink),	// @[Configs.scala:124:26]
    .auto_out_d_bits_denied     (_cork_auto_in_d_bits_denied),	// @[Configs.scala:124:26]
    .auto_out_d_bits_data       (_cork_auto_in_d_bits_data),	// @[Configs.scala:124:26]
    .auto_out_d_bits_corrupt    (_cork_auto_in_d_bits_corrupt),	// @[Configs.scala:124:26]
    .auto_out_d_bits_hit        (_cork_auto_in_d_bits_hit),	// @[Configs.scala:124:26]
    ...
    .auto_in_b_bits_hit         (_l2_auto_in_b_bits_hit),
    ...
    .auto_in_d_bits_hit         (_l2_auto_in_d_bits_hit),
  ...
  TLBuffer_11 InclusiveCache_inner_TLBuffer (	// @[Parameters.scala:56:69]
    ...
    .auto_out_a_ready        (_l2_auto_in_a_ready),	// @[Configs.scala:95:24]
    .auto_out_b_valid        (_l2_auto_in_b_valid),	// @[Configs.scala:95:24]
    .auto_out_b_bits_param   (_l2_auto_in_b_bits_param),	// @[Configs.scala:95:24]
    .auto_out_b_bits_address (_l2_auto_in_b_bits_address),	// @[Configs.scala:95:24]
    .auto_out_b_bits_hit     (_l2_auto_in_b_bits_hit),	// @[Configs.scala:95:24]
    .auto_out_c_ready        (_l2_auto_in_c_ready),	// @[Configs.scala:95:24]
    .auto_out_d_valid        (_l2_auto_in_d_valid),	// @[Configs.scala:95:24]
    .auto_out_d_bits_opcode  (_l2_auto_in_d_bits_opcode),	// @[Configs.scala:95:24]
    .auto_out_d_bits_param   (_l2_auto_in_d_bits_param),	// @[Configs.scala:95:24]
    .auto_out_d_bits_size    (_l2_auto_in_d_bits_size),	// @[Configs.scala:95:24]
    .auto_out_d_bits_source  (_l2_auto_in_d_bits_source),	// @[Configs.scala:95:24]
    .auto_out_d_bits_sink    (_l2_auto_in_d_bits_sink),	// @[Configs.scala:95:24]
    .auto_out_d_bits_denied  (_l2_auto_in_d_bits_denied),	// @[Configs.scala:95:24]
    .auto_out_d_bits_data    (_l2_auto_in_d_bits_data),	// @[Configs.scala:95:24]
    .auto_out_d_bits_corrupt (_l2_auto_in_d_bits_corrupt),	// @[Configs.scala:95:24]
    .auto_out_d_bits_hit     (_l2_auto_in_d_bits_hit),	// @[Configs.scala:95:24]
    ...
    .auto_in_b_bits_hit      (auto_coherent_jbar_in_b_bits_hit),
    ...
    .auto_in_d_bits_hit      (auto_coherent_jbar_in_d_bits_hit),
  ...
  TLCacheCork cork (	// @[Configs.scala:124:26]
    .clock                   (auto_subsystem_l2_clock_groups_in_member_subsystem_l2_0_clock),
    .reset                   (auto_subsystem_l2_clock_groups_in_member_subsystem_l2_0_reset),
    .auto_in_a_valid         (_l2_auto_out_a_valid),	// @[Configs.scala:95:24]
    .auto_in_a_bits_opcode   (_l2_auto_out_a_bits_opcode),	// @[Configs.scala:95:24]
    .auto_in_a_bits_param    (_l2_auto_out_a_bits_param),	// @[Configs.scala:95:24]
    .auto_in_a_bits_size     (_l2_auto_out_a_bits_size),	// @[Configs.scala:95:24]
    .auto_in_a_bits_source   (_l2_auto_out_a_bits_source),	// @[Configs.scala:95:24]
    .auto_in_a_bits_address  (_l2_auto_out_a_bits_address),	// @[Configs.scala:95:24]
    .auto_in_a_bits_mask     (_l2_auto_out_a_bits_mask),	// @[Configs.scala:95:24]
    .auto_in_a_bits_data     (_l2_auto_out_a_bits_data),	// @[Configs.scala:95:24]
    .auto_in_a_bits_corrupt  (_l2_auto_out_a_bits_corrupt),	// @[Configs.scala:95:24]
    .auto_in_c_valid         (_l2_auto_out_c_valid),	// @[Configs.scala:95:24]
    .auto_in_c_bits_opcode   (_l2_auto_out_c_bits_opcode),	// @[Configs.scala:95:24]
    .auto_in_c_bits_param    (_l2_auto_out_c_bits_param),	// @[Configs.scala:95:24]
    .auto_in_c_bits_size     (_l2_auto_out_c_bits_size),	// @[Configs.scala:95:24]
    .auto_in_c_bits_source   (_l2_auto_out_c_bits_source),	// @[Configs.scala:95:24]
    .auto_in_c_bits_address  (_l2_auto_out_c_bits_address),	// @[Configs.scala:95:24]
    .auto_in_c_bits_data     (_l2_auto_out_c_bits_data),	// @[Configs.scala:95:24]
    .auto_in_c_bits_corrupt  (_l2_auto_out_c_bits_corrupt),	// @[Configs.scala:95:24]
    .auto_in_d_ready         (_l2_auto_out_d_ready),	// @[Configs.scala:95:24]
    .auto_in_e_valid         (_l2_auto_out_e_valid),	// @[Configs.scala:95:24]
    .auto_in_e_bits_sink     (_l2_auto_out_e_bits_sink),	// @[Configs.scala:95:24]
    ...
    .auto_in_d_bits_hit      (_cork_auto_in_d_bits_hit),
  ...
  BankBinder binder (	// @[BankBinder.scala:68:28]
    .clock                   (auto_subsystem_l2_clock_groups_in_member_subsystem_l2_0_clock),
    .reset                   (auto_subsystem_l2_clock_groups_in_member_subsystem_l2_0_reset),
    .auto_in_a_valid         (_cork_auto_out_a_valid),	// @[Configs.scala:124:26]
    .auto_in_a_bits_opcode   (_cork_auto_out_a_bits_opcode),	// @[Configs.scala:124:26]
    .auto_in_a_bits_param    (_cork_auto_out_a_bits_param),	// @[Configs.scala:124:26]
    .auto_in_a_bits_size     (_cork_auto_out_a_bits_size),	// @[Configs.scala:124:26]
    .auto_in_a_bits_source   (_cork_auto_out_a_bits_source),	// @[Configs.scala:124:26]
    .auto_in_a_bits_address  (_cork_auto_out_a_bits_address),	// @[Configs.scala:124:26]
    .auto_in_a_bits_mask     (_cork_auto_out_a_bits_mask),	// @[Configs.scala:124:26]
    .auto_in_a_bits_data     (_cork_auto_out_a_bits_data),	// @[Configs.scala:124:26]
    .auto_in_a_bits_corrupt  (_cork_auto_out_a_bits_corrupt),	// @[Configs.scala:124:26]
    .auto_in_d_ready         (_cork_auto_out_d_ready),	// @[Configs.scala:124:26]
