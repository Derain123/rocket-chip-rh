...
module MulAddRecFNPipe_1(
  ...
  always @(posedge clock) begin
    if (io_validin) begin
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_isSigNaNAny <= _mulAddRecFNToRaw_preMul_io_toPostMul_isSigNaNAny;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_isNaNAOrB <= _mulAddRecFNToRaw_preMul_io_toPostMul_isNaNAOrB;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_isInfA <= _mulAddRecFNToRaw_preMul_io_toPostMul_isInfA;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_isZeroA <= _mulAddRecFNToRaw_preMul_io_toPostMul_isZeroA;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_isInfB <= _mulAddRecFNToRaw_preMul_io_toPostMul_isInfB;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_isZeroB <= _mulAddRecFNToRaw_preMul_io_toPostMul_isZeroB;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_signProd <= _mulAddRecFNToRaw_preMul_io_toPostMul_signProd;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_isNaNC <= _mulAddRecFNToRaw_preMul_io_toPostMul_isNaNC;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_isInfC <= _mulAddRecFNToRaw_preMul_io_toPostMul_isInfC;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_isZeroC <= _mulAddRecFNToRaw_preMul_io_toPostMul_isZeroC;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_sExpSum <= _mulAddRecFNToRaw_preMul_io_toPostMul_sExpSum;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_doSubMags <= _mulAddRecFNToRaw_preMul_io_toPostMul_doSubMags;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_CIsDominant <= _mulAddRecFNToRaw_preMul_io_toPostMul_CIsDominant;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_CDom_CAlignDist <= _mulAddRecFNToRaw_preMul_io_toPostMul_CDom_CAlignDist;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_highAlignedSigC <= _mulAddRecFNToRaw_preMul_io_toPostMul_highAlignedSigC;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_fromPreMul_b_bit0AlignedSigC <= _mulAddRecFNToRaw_preMul_io_toPostMul_bit0AlignedSigC;	// @[FPU.scala:654:41, Reg.scala:19:16]
      mulAddRecFNToRaw_postMul_io_mulAddResult_b <= {1'h0, {53'h0, _mulAddRecFNToRaw_preMul_io_mulAddA} * {53'h0, _mulAddRecFNToRaw_preMul_io_mulAddB}} + {1'h0, _mulAddRecFNToRaw_preMul_io_mulAddC};	// @[FPU.scala:654:41, :663:45, :664:50, Reg.scala:19:16, Valid.scala:130:22]
    ...
    if (valid_stage0_v) begin	// @[Valid.scala:130:22]
      roundRawFNToRecFN_io_invalidExc_b <= _mulAddRecFNToRaw_postMul_io_invalidExc;	// @[FPU.scala:655:42, Reg.scala:19:16]
      roundRawFNToRecFN_io_in_b_isNaN <= _mulAddRecFNToRaw_postMul_io_rawOut_isNaN;	// @[FPU.scala:655:42, Reg.scala:19:16]
      roundRawFNToRecFN_io_in_b_isInf <= _mulAddRecFNToRaw_postMul_io_rawOut_isInf;	// @[FPU.scala:655:42, Reg.scala:19:16]
      roundRawFNToRecFN_io_in_b_isZero <= _mulAddRecFNToRaw_postMul_io_rawOut_isZero;	// @[FPU.scala:655:42, Reg.scala:19:16]
      roundRawFNToRecFN_io_in_b_sign <= _mulAddRecFNToRaw_postMul_io_rawOut_sign;	// @[FPU.scala:655:42, Reg.scala:19:16]
      roundRawFNToRecFN_io_in_b_sExp <= _mulAddRecFNToRaw_postMul_io_rawOut_sExp;	// @[FPU.scala:655:42, Reg.scala:19:16]
      roundRawFNToRecFN_io_in_b_sig <= _mulAddRecFNToRaw_postMul_io_rawOut_sig;	// @[FPU.scala:655:42, Reg.scala:19:16]
  ...
  MulAddRecFNToRaw_preMul_1 mulAddRecFNToRaw_preMul (	// @[FPU.scala:654:41]
    .io_op                        (io_op),
    .io_a                         (io_a),
    .io_b                         (io_b),
    .io_c                         (io_c),
  ...
  MulAddRecFNToRaw_postMul_1 mulAddRecFNToRaw_postMul (	// @[FPU.scala:655:42]
  ...
  RoundRawFNToRecFN_1 roundRawFNToRecFN (	// @[FPU.scala:682:35]
