...
module TLMonitor_8(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~((~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & ~(io_in_a_bits_size[2]) & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_16 & ~reset & ~((~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & ~(io_in_a_bits_size[2]) & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:18], _RANDOM_1[16:0]};	// @[Edges.scala:229:27, Monitor.scala:388:22]
        ...
        source_1 = {_RANDOM_1[31:28], _RANDOM_2[1:0]};	// @[Monitor.scala:388:22, :538:22]
        sink = _RANDOM_2[2];	// @[Monitor.scala:538:22, :539:22]
        denied = _RANDOM_2[3];	// @[Monitor.scala:538:22, :540:22]
        inflight = {_RANDOM_2[31:4], _RANDOM_3[4:0]};	// @[Monitor.scala:538:22, :611:27]
        inflight_opcodes = {_RANDOM_3[31:5], _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7[8:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_7[31:9], _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11[12:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_11[15:13];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_11[18:16];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_11[31:19], _RANDOM_12[18:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = {_RANDOM_21[31], _RANDOM_22[1:0]};	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
