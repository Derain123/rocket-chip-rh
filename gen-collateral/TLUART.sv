...
module TLUART(
  ...
  wire [3:0][63:0] _GEN = {{{48'h0, div}}, {{30'h0, ip_rxwm, ip_txwm, 30'h0, ie_rxwm, ie_txwm}}, {{7'h0, rxwm, 15'h0, rxen, 7'h0, txwm, 14'h0, nstop, txen}}, {{~_rxq_io_deq_valid, 23'h0, _rxq_io_deq_bits, ~_txq_io_enq_ready, 31'h0}}};	// @[Bundles.scala:263:74, Cat.scala:33:92, MuxLiteral.scala:49:{10,48}, RegMapFIFO.scala:24:9, :45:21, RegisterRouter.scala:83:24, UART.scala:131:19, :134:19, :136:20, :142:21, :143:21, :150:21, :151:21, :152:22, :186:19, :189:28, :190:28]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      txen <= 1'h0;	// @[Bundles.scala:263:74, UART.scala:142:21]
      rxen <= 1'h0;	// @[Bundles.scala:263:74, UART.scala:143:21]
      txwm <= 9'h0;	// @[UART.scala:150:21]
      rxwm <= 9'h0;	// @[UART.scala:150:21, :151:21]
      nstop <= 1'h0;	// @[Bundles.scala:263:74, UART.scala:152:22]
      ie_rxwm <= 1'h0;	// @[Bundles.scala:263:74, UART.scala:186:19]
      ie_txwm <= 1'h0;	// @[Bundles.scala:263:74, UART.scala:186:19]
    end
    else begin
  ...
  Queue_60 txq (	// @[UART.scala:131:19]
    .clock        (clock),
    .reset        (reset),
  ...
  Queue_60 rxq (	// @[UART.scala:134:19]
    .clock        (clock),
    .reset        (reset),
  ...
  assign auto_control_xing_in_d_bits_data = _out_out_bits_data_WIRE_3 ? _GEN[auto_control_xing_in_a_bits_address[4:3]] : 64'h0;	// @[Bundles.scala:263:74, Cat.scala:33:92, MuxLiteral.scala:49:10, RegisterRouter.scala:83:24]
endmodule
