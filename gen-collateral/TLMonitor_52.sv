...
module TLMonitor_52(
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_15 = io_in_d_bits_source > 10'h20F;	// @[Parameters.scala:57:20]
    ...
    wire  [2111:0]   _GEN_19 = {2100'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, OneHot.scala:64:12]
    wire  [2111:0]   _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_19;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire  [527:0]    _GEN_20 = {518'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire  [527:0]    _T_618 = inflight >> _GEN_20;	// @[Monitor.scala:611:27, :682:25]
    wire  [2111:0]   _a_size_lookup_T_1 = inflight_sizes >> _GEN_19;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [527:0]    _T_697 = 528'h0 >> _GEN_20;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [2111:0]   _c_size_lookup_T_1 = 2112'h0 >> _GEN_19;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(io_in_a_bits_source < 10'h210 & io_in_a_bits_address[30:12] == 19'h54000)) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source < 10'h210 & io_in_a_bits_address[30:12] == 19'h54000)) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
