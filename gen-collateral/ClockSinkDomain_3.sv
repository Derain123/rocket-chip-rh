...
module ClockSinkDomain_3(
  ...
  input  [9:0]  auto_xbar_in_a_bits_source,
  ...
  output [9:0]  auto_xbar_in_d_bits_source,
  output [63:0] auto_xbar_in_d_bits_data,
  output        auto_xbar_in_d_bits_hit
);
  ...
  wire [9:0]  _reset_setter_auto_tl_in_d_bits_source;	// @[HasChipyardPRCI.scala:89:34]
  ...
  wire [9:0]  _clock_gater_auto_clock_gater_in_1_d_bits_source;	// @[HasChipyardPRCI.scala:84:33]
  ...
  wire [9:0]  _xbar_auto_out_1_a_bits_source;	// @[Xbar.scala:145:26]
  ...
  wire [9:0]  _xbar_auto_out_0_a_bits_source;	// @[Xbar.scala:145:26]
  ...
  TLXbar_11 xbar (	// @[Xbar.scala:145:26]
    ...
    .auto_in_d_bits_hit        (auto_xbar_in_d_bits_hit),
