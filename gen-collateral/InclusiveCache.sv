...
module InclusiveCache(
  ...
  input  [9:0]  auto_ctl_in_a_bits_source,
  ...
  output [9:0]  auto_ctl_in_d_bits_source,
  ...
  Queue_39 out_back (	// @[Decoupled.scala:375:21]
    .clock                               (clock),
    .reset                               (reset),
  ...
  InclusiveCacheBankScheduler inclusive_cache_bank_sched (	// @[InclusiveCache.scala:186:29]
    ...
    .io_out_d_bits_hit     (auto_out_d_bits_hit),
    ...
    .io_in_b_bits_hit      (auto_in_b_bits_hit),
    ...
    .io_in_d_bits_hit      (auto_in_d_bits_hit),
