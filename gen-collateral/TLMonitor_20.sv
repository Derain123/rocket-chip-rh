...
module TLMonitor_20(
  ...
  wire [515:0] _a_sizes_set_T_1 = {511'h0, _T_747 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {507'h0, io_in_a_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [263:0]    _GEN_23 = {255'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size < 4'h4 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size < 4'h4 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:25], _RANDOM_1[6:0]};	// @[Edges.scala:229:27, Monitor.scala:388:22]
        d_first_counter = _RANDOM_1[15:7];	// @[Edges.scala:229:27, Monitor.scala:388:22]
        opcode_1 = _RANDOM_1[18:16];	// @[Monitor.scala:388:22, :535:22]
        param_1 = _RANDOM_1[20:19];	// @[Monitor.scala:388:22, :536:22]
        size_1 = _RANDOM_1[24:21];	// @[Monitor.scala:388:22, :537:22]
        ...
        inflight_sizes = {_RANDOM_7[31:6], _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15[13:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_15[22:14];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_15[31:23];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        watchdog = _RANDOM_16;	// @[Monitor.scala:706:27]
        d_first_counter_2 = _RANDOM_30[30:22];	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
