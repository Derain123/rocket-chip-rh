...
module TLFragmenter(
  ...
  wire [5:0]  _GEN = {auto_out_d_bits_source[2:0], ~(_dsizeOH1_T_1[2:0])} & {1'h1, ~(auto_out_d_bits_source[2:0]), _dsizeOH1_T_1[2:1]};	// @[Cat.scala:33:92, Fragmenter.scala:194:41, package.scala:233:{35,47,49}, :235:{46,71,76}]
  ...
  TLMonitor_9 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_source  (auto_out_d_bits_source[9:4])	// @[Fragmenter.scala:228:47]
  );
  ...
  assign auto_in_d_bits_source = auto_out_d_bits_source[9:4];	// @[Fragmenter.scala:228:47]
