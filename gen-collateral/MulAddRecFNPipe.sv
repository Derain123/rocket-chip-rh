...
module MulAddRecFNPipe(
  ...
  always @(posedge clock) begin
    if (io_validin) begin
      ...
      mulAddRecFNToRaw_postMul_io_mulAddResult_b <= {1'h0, {24'h0, _mulAddRecFNToRaw_preMul_io_mulAddA} * {24'h0, _mulAddRecFNToRaw_preMul_io_mulAddB}} + {1'h0, _mulAddRecFNToRaw_preMul_io_mulAddC};	// @[FPU.scala:654:41, :663:45, :664:50, Reg.scala:19:16, Valid.scala:130:22]
  ...
  MulAddRecFNToRaw_preMul mulAddRecFNToRaw_preMul (	// @[FPU.scala:654:41]
    .io_op                        (io_op),
    .io_a                         (io_a),
    .io_b                         (io_b),
    .io_c                         (io_c),
  ...
  MulAddRecFNToRaw_postMul mulAddRecFNToRaw_postMul (	// @[FPU.scala:655:42]
  ...
  RoundRawFNToRecFN roundRawFNToRecFN (	// @[FPU.scala:682:35]
