...
module TLMonitor_15(
  ...
  wire [258:0] _a_opcodes_set_T_1 = {255'h0, _T_1161 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {252'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, OneHot.scala:64:12, Parameters.scala:52:29]
  wire [270:0] _d_sizes_clr_T_5 = 271'hFF << {263'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:677:76, :678:74]
  wire [259:0] _a_sizes_set_T_1 = {255'h0, _T_1161 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {252'h0, io_in_a_bits_source, 3'h0};	// @[Bundles.scala:263:74, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_365 = io_in_a_bits_size > 4'h2;	// @[Misc.scala:205:21]
    wire             mask_size = io_in_a_bits_size[1:0] == 2'h2;	// @[Bundles.scala:111:27, Misc.scala:208:26, OneHot.scala:63:49]
    wire             mask_acc = _T_365 | mask_size & ~(io_in_a_bits_address[2]);	// @[Misc.scala:205:21, :208:26, :209:26, :210:20, :214:{29,38}]
    wire             mask_acc_1 = _T_365 | mask_size & io_in_a_bits_address[2];	// @[Misc.scala:205:21, :208:26, :209:26, :214:{29,38}]
    ...
    wire  [75:0]     _a_opcode_lookup_T_1 = inflight_opcodes >> {69'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:613:35, :634:44, OneHot.scala:64:12]
    wire  [151:0]    _GEN_26 = {144'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~_T_365) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~_T_365) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_16 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(io_in_a_bits_source[4]) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & io_in_a_bits_size < 4'h4 & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(inflight == 19'h0 | _plusarg_reader_out == 32'h0 | watchdog < _plusarg_reader_out)) begin	// @[Monitor.scala:42:11, :611:27, :706:27, :709:{26,39,47,59}, :723:35, PlusArg.scala:80:11]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        source = _RANDOM_0[23:19];	// @[Edges.scala:229:27, Monitor.scala:387:22]
        address = {_RANDOM_0[31:24], _RANDOM_1[22:0]};	// @[Edges.scala:229:27, Monitor.scala:388:22]
        ...
        source_1 = _RANDOM_2[13:9];	// @[Monitor.scala:535:22, :538:22]
        sink = _RANDOM_2[14];	// @[Monitor.scala:535:22, :539:22]
        denied = _RANDOM_2[15];	// @[Monitor.scala:535:22, :540:22]
        inflight = {_RANDOM_2[31:16], _RANDOM_3[2:0]};	// @[Monitor.scala:535:22, :611:27]
        inflight_opcodes = {_RANDOM_3[31:3], _RANDOM_4, _RANDOM_5[14:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_5[31:15], _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9, _RANDOM_10[6:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_10[15:7];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_10[24:16];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_10[31:25], _RANDOM_11[24:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = {_RANDOM_19[31:25], _RANDOM_20[1:0]};	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
