...
module TLXbar_8(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch) begin	// @[Arbiter.scala:90:24]
        ...
        beatsLeft <= beatsLeft - {8'h0, auto_out_a_ready & x1_out_1_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, Bundles.scala:263:74, ReadyValidCancel.scala:49:33]
  ...
  assign auto_in_0_d_bits_hit = auto_out_d_bits_hit;
  assign auto_in_0_e_ready = auto_out_e_ready;
  assign auto_out_a_valid = x1_out_1_valid;	// @[Arbiter.scala:126:29]
  assign auto_out_a_bits_opcode = (muxStateEarly_0 ? auto_in_0_a_bits_opcode : 3'h0) | {muxStateEarly_1, 2'h0};	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  assign auto_out_a_bits_param = muxStateEarly_0 ? auto_in_0_a_bits_param : 3'h0;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_a_bits_size = (muxStateEarly_0 ? auto_in_0_a_bits_size : 4'h0) | (muxStateEarly_1 ? 4'h6 : 4'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h0, auto_in_0_a_bits_source} : 2'h0) | {muxStateEarly_1, 1'h0};	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73, Xbar.scala:240:29]
  assign auto_out_a_bits_address = (muxStateEarly_0 ? auto_in_0_a_bits_address : 32'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_address : 32'h0);	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? auto_in_0_a_bits_mask : 8'h0) | {8{muxStateEarly_1}};	// @[Arbiter.scala:118:30, Bundles.scala:263:74, Mux.scala:27:73]
