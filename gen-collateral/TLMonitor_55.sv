...
module TLMonitor_55(
  ...
  reg  [527:0]  inflight_1;	// @[Monitor.scala:723:35]
  reg  [2111:0] inflight_sizes_1;	// @[Monitor.scala:725:35]
  reg           d_first_counter_2;	// @[Edges.scala:229:27]
  reg  [31:0]   watchdog_1;	// @[Monitor.scala:815:27]
  wire [1023:0] _GEN = {1014'h0, io_in_d_bits_source};	// @[OneHot.scala:57:35]
  wire [8206:0] _GEN_0 = {8195'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76]
  wire [1023:0] _d_clr_T = 1024'h1 << _GEN;	// @[OneHot.scala:57:35]
  wire [1023:0] _a_set_T = 1024'h1 << io_in_a_bits_source;	// @[OneHot.scala:57:35]
  wire [8206:0] _d_opcodes_clr_T_5 = 8207'hF << _GEN_0;	// @[Monitor.scala:677:76]
  wire [8194:0] _a_opcodes_set_T_1 = {8191'h0, _T_598 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {8183'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:42:11, :632:35, :643:40, :652:{27,72}, :654:{28,53}, :656:54]
  wire [8206:0] _d_sizes_clr_T_5 = 8207'hF << _GEN_0;	// @[Monitor.scala:677:76, :678:74]
  wire [8193:0] _a_sizes_set_T_1 = {8191'h0, _T_598 ? {io_in_a_bits_size, 1'h1} : 3'h0} << {8182'h0, io_in_a_bits_source, 2'h0};	// @[Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  wire [1023:0] _d_clr_T_1 = 1024'h1 << _GEN;	// @[OneHot.scala:57:35]
  wire [8206:0] _d_sizes_clr_T_11 = 8207'hF << _GEN_0;	// @[Monitor.scala:677:76, :788:74]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= 528'h0;	// @[Monitor.scala:611:27]
      inflight_opcodes <= 2112'h0;	// @[Monitor.scala:613:35]
      inflight_sizes <= 2112'h0;	// @[Monitor.scala:613:35, :615:33]
      a_first_counter_1 <= 1'h0;	// @[Edges.scala:229:27]
      d_first_counter_1 <= 1'h0;	// @[Edges.scala:229:27]
      watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      inflight_1 <= 528'h0;	// @[Monitor.scala:611:27, :723:35]
      inflight_sizes_1 <= 2112'h0;	// @[Monitor.scala:613:35, :725:35]
      ...
      inflight <= (inflight | (_T_598 ? _a_set_T[527:0] : 528'h0)) & ~(_T_613 ? _d_clr_T[527:0] : 528'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_598 ? _a_opcodes_set_T_1[2111:0] : 2112'h0)) & ~(_T_613 ? _d_opcodes_clr_T_5[2111:0] : 2112'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}]
      inflight_sizes <= (inflight_sizes | (_T_598 ? _a_sizes_set_T_1[2111:0] : 2112'h0)) & ~(_T_613 ? _d_sizes_clr_T_5[2111:0] : 2112'h0);	// @[Monitor.scala:613:35, :615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}]
      ...
      inflight_1 <= inflight_1 & ~(_T_693 ? _d_clr_T_1[527:0] : 528'h0);	// @[Monitor.scala:611:27, :723:35, :771:34, :785:{72,90}, :786:21, :811:{44,46}, OneHot.scala:57:35]
      inflight_sizes_1 <= inflight_sizes_1 & ~(_T_693 ? _d_sizes_clr_T_11[2111:0] : 2112'h0);	// @[Monitor.scala:613:35, :725:35, :774:34, :785:{72,90}, :788:{21,74}, :813:{56,58}]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_5 = io_in_a_bits_source > 10'h20F;	// @[Parameters.scala:57:20]
    ...
    wire             _GEN_16 = io_in_d_bits_source > 10'h20F;	// @[Parameters.scala:57:20]
    ...
    wire  [2111:0]   _GEN_20 = {2100'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44]
    wire  [2111:0]   _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_20;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire  [527:0]    _GEN_21 = {518'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    ...
    wire  [527:0]    _T_618 = inflight >> _GEN_21;	// @[Monitor.scala:611:27, :682:25]
    wire  [2111:0]   _a_size_lookup_T_1 = inflight_sizes >> _GEN_20;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [527:0]    _T_697 = inflight_1 >> _GEN_21;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [2111:0]   _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_20;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source < 10'h210 & io_in_a_bits_address[20:12] == 9'h110)) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_source < 10'h210 & io_in_a_bits_address[20:12] == 9'h110)) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:57:20, :137:{31,65}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(inflight == 528'h0 | _plusarg_reader_out == 32'h0 | watchdog < _plusarg_reader_out)) begin	// @[Monitor.scala:42:11, :611:27, :706:27, :709:{26,39,47,59}, PlusArg.scala:80:11]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(inflight_1 == 528'h0 | _plusarg_reader_1_out == 32'h0 | watchdog_1 < _plusarg_reader_1_out)) begin	// @[Monitor.scala:42:11, :611:27, :706:27, :723:35, :815:27, :818:{26,39,47,59}, PlusArg.scala:80:11]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: TileLink timeout expired (connected at HasChipyardPRCI.scala:91:25)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
