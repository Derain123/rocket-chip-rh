...
module AsyncQueueSource_4(
  ...
  reg         mem_0_hit;	// @[AsyncQueue.scala:80:16]
  ...
  always @(posedge clock) begin
    ...
    mem_0_hit <= _T | mem_0_hit;	// @[AsyncQueue.scala:80:16, :86:{24,37}, Decoupled.scala:51:35]
  end // always @(posedge)
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_hit = _RANDOM_1[11];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_1[12];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_1[13];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = _RANDOM_1[14];	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 1'h0;	// @[AsyncQueue.scala:52:25]
  ...
  assign io_async_mem_0_hit = mem_0_hit;	// @[AsyncQueue.scala:80:16]
