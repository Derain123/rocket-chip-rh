...
module GenericDeserializer_TestHarness_UNIQUIFIED(
  ...
  assign io_out_bits_chanId = data_5[4:2];	// @[Serdes.scala:200:17, :207:38]
  assign io_out_bits_opcode = {data_5[1:0], data_4[31]};	// @[Serdes.scala:200:17, :207:38]
  assign io_out_bits_param = data_4[30:28];	// @[Serdes.scala:200:17, :207:38]
  assign io_out_bits_size = data_4[27:20];	// @[Serdes.scala:200:17, :207:38]
  assign io_out_bits_source = data_4[19:12];	// @[Serdes.scala:200:17, :207:38]
  assign io_out_bits_address = {data_4[11:0], data_3, data_2[31:12]};	// @[Serdes.scala:200:17, :207:38]
  assign io_out_bits_data = {data_2[11:0], data_1, data_0[31:12]};	// @[Serdes.scala:200:17, :207:38]
  assign io_out_bits_corrupt = data_0[11];	// @[Serdes.scala:200:17, :207:38]
  assign io_out_bits_union = data_0[10:2];	// @[Serdes.scala:200:17, :207:38]
  assign io_out_bits_hit = data_0[0];	// @[Serdes.scala:200:17, :207:38]
endmodule
