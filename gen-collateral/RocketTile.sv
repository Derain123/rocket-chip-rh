...
module RocketTile(
  ...
  wire        _dcacheArb_io_requestor_1_perf_grant;	// @[HellaCache.scala:279:25]
  ...
  wire        _dcacheArb_io_mem_req_bits_dv;	// @[HellaCache.scala:279:25]
  ...
  wire        _fpuOpt_io_fcsr_flags_valid;	// @[RocketTile.scala:205:62]
  wire [4:0]  _fpuOpt_io_fcsr_flags_bits;	// @[RocketTile.scala:205:62]
  wire [63:0] _fpuOpt_io_store_data;	// @[RocketTile.scala:205:62]
  wire [63:0] _fpuOpt_io_toint_data;	// @[RocketTile.scala:205:62]
  wire        _fpuOpt_io_fcsr_rdy;	// @[RocketTile.scala:205:62]
  wire        _fpuOpt_io_nack_mem;	// @[RocketTile.scala:205:62]
  wire        _fpuOpt_io_illegal_rm;	// @[RocketTile.scala:205:62]
  wire        _fpuOpt_io_dec_wen;	// @[RocketTile.scala:205:62]
  wire        _fpuOpt_io_dec_ren1;	// @[RocketTile.scala:205:62]
  wire        _fpuOpt_io_dec_ren2;	// @[RocketTile.scala:205:62]
  wire        _fpuOpt_io_dec_ren3;	// @[RocketTile.scala:205:62]
  wire        _fpuOpt_io_sboard_set;	// @[RocketTile.scala:205:62]
  wire        _fpuOpt_io_sboard_clr;	// @[RocketTile.scala:205:62]
  wire [4:0]  _fpuOpt_io_sboard_clra;	// @[RocketTile.scala:205:62]
  ...
  wire        _dcache_auto_out_a_bits_source;	// @[HellaCache.scala:268:43]
  wire [31:0] _dcache_auto_out_a_bits_address;	// @[HellaCache.scala:268:43]
  wire [7:0]  _dcache_auto_out_a_bits_mask;	// @[HellaCache.scala:268:43]
  wire [63:0] _dcache_auto_out_a_bits_data;	// @[HellaCache.scala:268:43]
  ...
  wire        _dcache_auto_out_c_bits_source;	// @[HellaCache.scala:268:43]
  wire [31:0] _dcache_auto_out_c_bits_address;	// @[HellaCache.scala:268:43]
  wire [63:0] _dcache_auto_out_c_bits_data;	// @[HellaCache.scala:268:43]
  wire        _dcache_auto_out_d_ready;	// @[HellaCache.scala:268:43]
  wire        _dcache_auto_out_e_valid;	// @[HellaCache.scala:268:43]
  wire [2:0]  _dcache_auto_out_e_bits_sink;	// @[HellaCache.scala:268:43]
  ...
  wire        _dcache_io_cpu_perf_grant;	// @[HellaCache.scala:268:43]
  wire        _dcache_io_cpu_l2hit;	// @[HellaCache.scala:268:43]
  ...
  wire        _tlMasterXbar_auto_in_0_b_bits_hit;	// @[BaseTile.scala:223:42]
  ...
  wire        _tlMasterXbar_auto_in_0_d_bits_hit;	// @[BaseTile.scala:223:42]
  ...
  TLXbar_8 tlMasterXbar (	// @[BaseTile.scala:223:42]
    ...
    .auto_out_b_bits_hit      (auto_buffer_out_b_bits_hit),
    ...
    .auto_out_d_bits_hit      (auto_buffer_out_d_bits_hit),
    ...
    .auto_in_0_b_bits_hit     (_tlMasterXbar_auto_in_0_b_bits_hit),
    ...
    .auto_in_0_d_bits_hit     (_tlMasterXbar_auto_in_0_d_bits_hit),
  ...
  DCache dcache (	// @[HellaCache.scala:268:43]
    .clock                             (clock),
    .reset                             (reset),
    ...
    .auto_out_b_bits_hit               (_tlMasterXbar_auto_in_0_b_bits_hit),	// @[BaseTile.scala:223:42]
    ...
    .auto_out_d_bits_hit               (_tlMasterXbar_auto_in_0_d_bits_hit),	// @[BaseTile.scala:223:42]
    ...
    .io_cpu_req_bits_dv                (_dcacheArb_io_mem_req_bits_dv),	// @[HellaCache.scala:279:25]
    ...
    .io_cpu_l2hit                      (_dcache_io_cpu_l2hit),
  ...
  FPU fpuOpt (	// @[RocketTile.scala:205:62]
    .clock               (clock),
    .reset               (reset),
  ...
  HellaCacheArbiter dcacheArb (	// @[HellaCache.scala:279:25]
    .clock                                     (clock),
    ...
    .io_mem_perf_grant                         (_dcache_io_cpu_perf_grant),	// @[HellaCache.scala:268:43]
  ...
  PTW ptw (	// @[PTW.scala:793:19]
    ...
    .io_requestor_0_req_bits_valid          (1'h1),	// @[HellaCache.scala:268:43]
  ...
  Rocket core (	// @[RocketTile.scala:127:20]
    ...
    .io_dmem_perf_grant                         (_dcacheArb_io_requestor_1_perf_grant),	// @[HellaCache.scala:279:25]
    .io_fpu_fcsr_flags_valid                    (_fpuOpt_io_fcsr_flags_valid),	// @[RocketTile.scala:205:62]
    .io_fpu_fcsr_flags_bits                     (_fpuOpt_io_fcsr_flags_bits),	// @[RocketTile.scala:205:62]
    .io_fpu_store_data                          (_fpuOpt_io_store_data),	// @[RocketTile.scala:205:62]
    .io_fpu_toint_data                          (_fpuOpt_io_toint_data),	// @[RocketTile.scala:205:62]
    .io_fpu_fcsr_rdy                            (_fpuOpt_io_fcsr_rdy),	// @[RocketTile.scala:205:62]
    .io_fpu_nack_mem                            (_fpuOpt_io_nack_mem),	// @[RocketTile.scala:205:62]
    .io_fpu_illegal_rm                          (_fpuOpt_io_illegal_rm),	// @[RocketTile.scala:205:62]
    .io_fpu_dec_wen                             (_fpuOpt_io_dec_wen),	// @[RocketTile.scala:205:62]
    .io_fpu_dec_ren1                            (_fpuOpt_io_dec_ren1),	// @[RocketTile.scala:205:62]
    .io_fpu_dec_ren2                            (_fpuOpt_io_dec_ren2),	// @[RocketTile.scala:205:62]
    .io_fpu_dec_ren3                            (_fpuOpt_io_dec_ren3),	// @[RocketTile.scala:205:62]
    .io_fpu_sboard_set                          (_fpuOpt_io_sboard_set),	// @[RocketTile.scala:205:62]
    .io_fpu_sboard_clr                          (_fpuOpt_io_sboard_clr),	// @[RocketTile.scala:205:62]
    .io_fpu_sboard_clra                         (_fpuOpt_io_sboard_clra),	// @[RocketTile.scala:205:62]
